...
import { ApiTypes, AugmentedSubmittable, SubmittableExtrinsic, SubmittableExtrinsicFunction, SubmittableModuleExtrinsics } from '@cennznet/api/types';
import {AssetOptionsValue} from "@cennznet/crml-generic-asset/types";
import {AnyAddress, AnyAssetId} from "@cennznet/types/types";

declare module '@cennznet/api/submittable/types' {
  export interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    genericAsset: {
       ...
       */
      create: AugmentedSubmittable<(owner: AnyAddress, options: AssetOptionsValue) => SubmittableExtrinsic<ApiType>>;
       ...
       */
      transfer: AugmentedSubmittable<(assetId: AnyAssetId, dest: AnyAddress, amount: AnyNumber) => SubmittableExtrinsic<ApiType>>;
       ...
       */
      mint: AugmentedSubmittable<(assetId: AnyAssetId, destination: AnyAddress, amount: AnyNumber) => SubmittableExtrinsic<ApiType>>;
       ...
       */
      burn: AugmentedSubmittable<(assetId: AnyAssetId, source: AnyAddress, amount: AnyNumber) => SubmittableExtrinsic<ApiType>>;
    };
  }
