...
import { ApiInterfaceRx, ApiOptionsBase, ApiTypes, DecoratedRpc, DecorateMethod, QueryableStorage, QueryableStorageMulti, SubmittableExtrinsics, Signer } from '../types';
...
let pkgJson: PkgJson = { name: '@cennznet/api', version: '-' };
