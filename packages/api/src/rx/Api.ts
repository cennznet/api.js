...
import { ApiOptionsBase, DecorateFn } from '../types';
...
export default class ApiRx extends ApiBase<'rxjs'> {
   ...
   * @param options options that is passed to the class contructor. Can be either [[ApiOptionsBase]] or [[WsProvider]]
   * @example
   * <BR>
   *
   * ```javascript
   ...
   * ```
   */
  public static create (options?: ApiOptionsBase): Observable<ApiRx> {
    return new ApiRx(options).isReady;
  }

  /**
   * @description Create an instance of the ApiRx class
   * @param options Options to create an instance. Can be either [[ApiOptionsBase]] or [[WsProvider]]
   * @example
   * <BR>
   *
   * ```javascript
