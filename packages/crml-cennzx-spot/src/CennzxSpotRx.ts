...
export class CennzxSpotRx {
    ...
    get getOutputPrice(): QueryablePriceRx {
        const _fn = this.api.derive.cennzxSpot.outputPrice as QueryablePriceRx;
    ...
    get getInputPrice(): QueryablePriceRx {
        const _fn = this.api.derive.cennzxSpot.inputPrice as QueryablePriceRx;
    ...
    get liquidityPrice(): QueryableGetLiquidityBalancePriceRx {
        const _fn = this.api.derive.cennzxSpot.liquidityPrice as QueryableGetLiquidityBalancePriceRx;
