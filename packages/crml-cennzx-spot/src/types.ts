...
export interface QueryableGetLiquidityBalance {
  ...
  at(hash: Hash, assetId: AnyAssetId, address: AnyAddress): Promise<BN>;
}

export interface QueryableGetLiquidityBalanceRx {
  (assetId: AnyAssetId, address: AnyAddress): Observable<BN>;

  at(hash: Hash, assetId: AnyAssetId, address: AnyAddress): Observable<BN>;
}
...
export interface QueryableTotalLiquidityBalance {
  ...
  at(hash: Hash, assetId: AnyAssetId): Promise<BN>;
}

export interface QueryableTotalLiquidityBalanceRx {
  (assetId: AnyAssetId): Observable<BN>;

  at(hash: Hash, assetId: AnyAssetId): Observable<BN>;
}
...
export interface QueryablePrice {
  ...
  at(hash: Hash, assetA: AnyNumber, assetB: AnyNumber, amountBought: AnyNumber): Promise<BN>;
}

export interface QueryablePriceRx {
  (assetA: AnyNumber, assetB: AnyNumber, amountBought: AnyNumber): Observable<BN>;

  at(hash: Hash, assetA: AnyNumber, assetB: AnyNumber, amountBought: AnyNumber): Observable<BN>;
}
...
export interface QueryableGetLiquidityBalancePrice {
  ...
  at(hash: Hash, assetId: AnyAssetId, coreAmount: AnyNumber): Promise<BN>;
}

export interface QueryableGetLiquidityBalancePriceRx {
  (assetId: AnyAssetId, coreAmount: AnyNumber): Observable<BN>;

  at(hash: Hash, assetId: AnyAssetId, coreAmount: AnyNumber): Observable<BN>;
}
...
export interface QueryableGetAssetWithdrawn {
  ...
  at(hash: Hash, assetId: AnyAssetId, coreAmount: AnyNumber): Promise<{coreAmount: BN; assetAmount: BN}>;
}
...
export interface QueryableGetAssetWithdrawnRx {
  ...
  at(hash: Hash, assetId: AnyAssetId, coreAmount: AnyNumber): Observable<{coreAmount: BN; assetAmount: BN}>;
}
