...
### Added:
    - added type MetadataBaseURI for nft module
    - added missing rpc definition for nft and generic asset module
### Changed:
    - updated reasons type from WithdrawReasons to Reason for BalanceLock
