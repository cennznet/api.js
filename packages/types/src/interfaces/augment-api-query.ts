...
import type { CollectionId, CollectionNameType, Listing, ListingId, Marketplace, MarketplaceId, MassDrop, MetadataBaseURI, NFTAttributeValue, RoyaltiesSchedule, SerialNumber, SeriesId, TokenCount, TokenId, TokenLockReason } from '@cennznet/types/interfaces/nft';
...
declare module '@polkadot/api/types/storage' {
  export interface AugmentedQueries<ApiType> {
    ...
    nft: {
       ...
       **/
      presaleWhitelist: AugmentedQueryDoubleMap<ApiType, (key1: ITuple<[CollectionId, SeriesId]> | [CollectionId | AnyNumber | Uint8Array, SeriesId | AnyNumber | Uint8Array], key2: AccountId | string | Uint8Array) => Observable<bool>, [ITuple<[CollectionId, SeriesId]>, AccountId]> & QueryableStorageEntry<ApiType, [ITuple<[CollectionId, SeriesId]>, AccountId]>;
      /**
       ...
       **/
      seriesMassDrops: AugmentedQueryDoubleMap<ApiType, (key1: CollectionId | AnyNumber | Uint8Array, key2: SeriesId | AnyNumber | Uint8Array) => Observable<Option<MassDrop>>, [CollectionId, SeriesId]> & QueryableStorageEntry<ApiType, [CollectionId, SeriesId]>;
      /**
       * Map from a token series to its metadata URI path. This should be joined wih the collection base path
       **/
