...
import type { ProposalId, ProposalStatusInfo, ProposalVoteInfo, ReferendumVoteCount } from '@cennznet/types/interfaces/governance';
import type { CollectionId, CollectionNameType, Listing, ListingId, Marketplace, MarketplaceId, MetadataScheme, NFTAttributeValue, RoyaltiesSchedule, SerialNumber, SeriesId, TokenCount, TokenId, TokenLockReason } from '@cennznet/types/interfaces/nft';
...
import type { AccountId, AssetId, Balance, BalanceOf, BlockNumber, FixedU128, Hash, KeyTypeId, Moment, OpaqueCall, Perbill, Percent, Permill, Releases, Slot, ValidatorId } from '@polkadot/types/interfaces/runtime';
...
declare module '@polkadot/api/types/storage' {
  export interface AugmentedQueries<ApiType> {
    ...
    ethBridge: {
       ...
       **/
      notarySetProofId: AugmentedQuery<ApiType, () => Observable<EventProofId>, []> & QueryableStorageEntry<ApiType, []>;
      /**
    ...
    governance: {
       ...
       **/
      minimumCouncilStake: AugmentedQuery<ApiType, () => Observable<Balance>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Minimum amount of staked CENNZ required to vote
       **/
      minVoterStakedAmount: AugmentedQuery<ApiType, () => Observable<Balance>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       ...
       **/
      referendumStartTime: AugmentedQuery<ApiType, (arg: ProposalId | AnyNumber | Uint8Array) => Observable<Option<BlockNumber>>, [ProposalId]> & QueryableStorageEntry<ApiType, [ProposalId]>;
      /**
       ...
       **/
      referendumVetoSum: AugmentedQuery<ApiType, (arg: ProposalId | AnyNumber | Uint8Array) => Observable<u32>, [ProposalId]> & QueryableStorageEntry<ApiType, [ProposalId]>;
      /**
       * Map from proposal Id to referendum votes
       **/
      referendumVotes: AugmentedQueryDoubleMap<ApiType, (key1: ProposalId | AnyNumber | Uint8Array, key2: AccountId | string | Uint8Array) => Observable<ReferendumVoteCount>, [ProposalId, AccountId]> & QueryableStorageEntry<ApiType, [ProposalId, AccountId]>;
    };
    grandpa: {
      [key: string]: QueryableStorageEntry<ApiType>;
      /**
    ...
    nft: {
       ...
       **/
      nextMarketplaceId: AugmentedQuery<ApiType, () => Observable<MarketplaceId>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       ...
       **/
      registeredMarketplaces: AugmentedQuery<ApiType, (arg: MarketplaceId | AnyNumber | Uint8Array) => Observable<Marketplace>, [MarketplaceId]> & QueryableStorageEntry<ApiType, [MarketplaceId]>;
      /**
       ...
       **/
      seriesMetadataScheme: AugmentedQueryDoubleMap<ApiType, (key1: CollectionId | AnyNumber | Uint8Array, key2: SeriesId | AnyNumber | Uint8Array) => Observable<Option<MetadataScheme>>, [CollectionId, SeriesId]> & QueryableStorageEntry<ApiType, [CollectionId, SeriesId]>;
      /**
