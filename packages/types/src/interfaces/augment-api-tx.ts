  ...
  export interface AugmentedSubmittables<ApiType> {
    ...
    cennzx: {
      ...
      addLiquidity: AugmentedSubmittable<
        (
          ...
          minLiquidity: Compact<Balance> | AnyNumber | Uint8Array,
          maxAssetAmount: Compact<Balance> | AnyNumber | Uint8Array,
          coreAmount: Compact<Balance> | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>
      >;
      /**
      ...
      buyAsset: AugmentedSubmittable<
        (
          recipient: Option<AccountId> | null | object | string | Uint8Array,
          assetToSell: Compact<AssetId> | AnyNumber | Uint8Array,
          assetToBuy: Compact<AssetId> | AnyNumber | Uint8Array,
          buyAmount: Compact<Balance> | AnyNumber | Uint8Array,
          maximumSell: Compact<Balance> | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>
      >;
      /**
      ...
      removeLiquidity: AugmentedSubmittable<
        (
          assetId: Compact<AssetId> | AnyNumber | Uint8Array,
          liquidityToWithdraw: Compact<Balance> | AnyNumber | Uint8Array,
          minAssetWithdraw: Compact<Balance> | AnyNumber | Uint8Array,
          minCoreWithdraw: Compact<Balance> | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>
      >;
      /**
       ...
       **/
      sellAsset: AugmentedSubmittable<
        (
          recipient: Option<AccountId> | null | object | string | Uint8Array,
          assetToSell: Compact<AssetId> | AnyNumber | Uint8Array,
          assetToBuy: Compact<AssetId> | AnyNumber | Uint8Array,
          sellAmount: Compact<Balance> | AnyNumber | Uint8Array,
          minimumBuy: Compact<Balance> | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>
      >;
      /**
    ...
    genericAsset: {
      ...
      create: AugmentedSubmittable<
        (
          owner: AccountId | string | Uint8Array,
          options: AssetOptions | { initialIssuance?: any; permissions?: any } | string | Uint8Array,
          info: AssetInfo | { symbol?: any; decimalPlaces?: any } | string | Uint8Array
        ) => SubmittableExtrinsic<ApiType>
      >;
      /**
       ...
       **/
      createReserved: AugmentedSubmittable<
        (
       ...
       * Expected to not be called frequently
       **/
      updatePermission: AugmentedSubmittable<
        (
          assetId: Compact<AssetId> | AnyNumber | Uint8Array,
          newPermission: PermissionLatest | { update?: any; mint?: any; burn?: any } | string | Uint8Array
        ) => SubmittableExtrinsic<ApiType>
      >;
    };
    grandpa: {
    ...
    identity: {
      ...
      addSub: AugmentedSubmittable<
        (
          sub: LookupSource | Address | AccountId | AccountIndex | LookupSource | string | Uint8Array,
          data:
            | Data
            | { None: any }
            | { Raw: any }
      ...
      cancelRequest: AugmentedSubmittable<
        (regIndex: RegistrarIndex | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>
      >;
      /**
      ...
      killIdentity: AugmentedSubmittable<
        (
          target: LookupSource | Address | AccountId | AccountIndex | LookupSource | string | Uint8Array
        ) => SubmittableExtrinsic<ApiType>
      >;
      /**
      ...
      setAccountId: AugmentedSubmittable<
        (
          index: Compact<RegistrarIndex> | AnyNumber | Uint8Array,
    ...
    staking: {
      ...
      bondExtra: AugmentedSubmittable<
        (maxAdditional: Compact<BalanceOf> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>
      >;
      /**
      ...
      nominate: AugmentedSubmittable<
        (targets: Vec<AccountId> | (AccountId | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>
      >;
      /**
      ...
      setInvulnerables: AugmentedSubmittable<
        (validators: Vec<AccountId> | (AccountId | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>
      >;
      /**
       * Set the minimum bond amount.
       **/
      setMinimumBond: AugmentedSubmittable<
        (value: BalanceOf | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>
      >;
      /**
      ...
      validate: AugmentedSubmittable<
        (prefs: ValidatorPrefs | { commission?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>
      >;
      /**
    ...
    sudo: {
      ...
      setKey: AugmentedSubmittable<
        (
          updated: LookupSource | Address | AccountId | AccountIndex | LookupSource | string | Uint8Array
        ) => SubmittableExtrinsic<ApiType>
      >;
      /**
    ...
    syloE2Ee: {
       ...
       **/
      registerDevice: AugmentedSubmittable<
        (
          deviceId: DeviceId | AnyNumber | Uint8Array,
          pkbs: Vec<PreKeyBundle> | (PreKeyBundle | string | Uint8Array)[]
        ) => SubmittableExtrinsic<ApiType>
      >;
      /**
       ...
       * 1 write.
       **/
      replenishPkbs: AugmentedSubmittable<
        (
          deviceId: DeviceId | AnyNumber | Uint8Array,
          pkbs: Vec<PreKeyBundle> | (PreKeyBundle | string | Uint8Array)[]
        ) => SubmittableExtrinsic<ApiType>
       ...
       **/
      withdrawPkbs: AugmentedSubmittable<
        (
          requestId: Hash | string | Uint8Array,
          wantedPkbs:
            | Vec<ITuple<[AccountId, DeviceId]>>
            | [AccountId | string | Uint8Array, DeviceId | AnyNumber | Uint8Array][]
        ) => SubmittableExtrinsic<ApiType>
      >;
    };
    syloGroups: {
      ...
      acceptInvite: AugmentedSubmittable<
        (
          groupId: Hash | string | Uint8Array,
          payload: AcceptPayload | { accountId?: any } | string | Uint8Array,
          inviteKey: H256 | string | Uint8Array,
          inboxId: u32 | AnyNumber | Uint8Array,
          signature: Signature | string | Uint8Array,
          groupData: ITuple<[VaultKey, VaultValue]> | [VaultKey | string | Uint8Array, VaultValue | string | Uint8Array]
        ) => SubmittableExtrinsic<ApiType>
      >;
      /**
      ...
      createGroup: AugmentedSubmittable<
        (
          ...
          invites:
            ...
            | (
                | Invite
                | { peerId?: any; inviteData?: any; inviteKey?: any; meta?: any; roles?: any }
                | string
                | Uint8Array
              )[],
          groupData: ITuple<[VaultKey, VaultValue]> | [VaultKey | string | Uint8Array, VaultValue | string | Uint8Array]
       ...
       **/
      createInvites: AugmentedSubmittable<
        (
          groupId: Hash | string | Uint8Array,
          invites:
            | Vec<Invite>
      ...
      leaveGroup: AugmentedSubmittable<
        (
          groupId: Hash | string | Uint8Array,
          groupKey: Option<VaultKey> | null | object | string | Uint8Array
        ) => SubmittableExtrinsic<ApiType>
      >;
      /**
       ...
       * Limited number of read and writes
       **/
      revokeInvites: AugmentedSubmittable<
        (
          groupId: Hash | string | Uint8Array,
          inviteKeys: Vec<H256> | (H256 | string | Uint8Array)[]
        ) => SubmittableExtrinsic<ApiType>
      >;
      /**
       ...
       **/
      updateMember: AugmentedSubmittable<
        (groupId: Hash | string | Uint8Array, meta: Meta) => SubmittableExtrinsic<ApiType>
      >;
      /**
       ...
       **/
      upsertGroupMeta: AugmentedSubmittable<
        (groupId: Hash | string | Uint8Array, meta: Meta) => SubmittableExtrinsic<ApiType>
      >;
    };
    syloInbox: {
       ...
       * 1 write
       **/
      addValue: AugmentedSubmittable<
        (peerId: AccountId | string | Uint8Array, value: Message | string | Uint8Array) => SubmittableExtrinsic<ApiType>
      >;
      /**
       ...
       * 1 write
       **/
      deleteValues: AugmentedSubmittable<
        (valueIds: Vec<MessageId> | (MessageId | AnyNumber | Uint8Array)[]) => SubmittableExtrinsic<ApiType>
      >;
    };
    syloPayment: {
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
       ...
       **/
      setPaymentAccount: AugmentedSubmittable<
    ...
    syloVault: {
       ...
       **/
      deleteValues: AugmentedSubmittable<
        (keys: Vec<VaultKey> | (VaultKey | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>
      >;
      /**
       ...
       * 1 write
       **/
      upsertValue: AugmentedSubmittable<
        (key: VaultKey | string | Uint8Array, value: VaultValue | string | Uint8Array) => SubmittableExtrinsic<ApiType>
      >;
    };
    system: {
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    treasury: {
      ...
      acceptCurator: AugmentedSubmittable<
        (bountyId: Compact<ProposalIndex> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>
      >;
      /**
      ...
      awardBounty: AugmentedSubmittable<
        (
          bountyId: Compact<ProposalIndex> | AnyNumber | Uint8Array,
          beneficiary: LookupSource | Address | AccountId | AccountIndex | LookupSource | string | Uint8Array
        ) => SubmittableExtrinsic<ApiType>
      >;
      /**
      ...
      proposeCurator: AugmentedSubmittable<
        (
          bountyId: Compact<ProposalIndex> | AnyNumber | Uint8Array,
          curator: LookupSource | Address | AccountId | AccountIndex | LookupSource | string | Uint8Array,
          fee: Compact<BalanceOf> | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>
      >;
      /**
