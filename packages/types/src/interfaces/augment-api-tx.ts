...
import type { CollectionId, CollectionNameType, ListingId, MarketplaceId, MassDrop, MetadataBaseURI, NFTAttributeValue, Presale, RoyaltiesSchedule, SerialNumber, SeriesId, TokenCount, TokenId } from '@cennznet/types/interfaces/nft';
...
declare module '@polkadot/api/types/submittable' {
  export interface AugmentedSubmittables<ApiType> {
    ...
    nft: {
       ...
       **/
      enterMassDrop: AugmentedSubmittable<(collectionId: CollectionId | AnyNumber | Uint8Array, seriesId: SeriesId | AnyNumber | Uint8Array, quantity: TokenCount | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [CollectionId, SeriesId, TokenCount]>;
      /**
       ...
       **/
      mintSeries: AugmentedSubmittable<(collectionId: CollectionId | AnyNumber | Uint8Array, quantity: TokenCount | AnyNumber | Uint8Array, owner: Option<AccountId> | null | object | string | Uint8Array, attributes: Vec<NFTAttributeValue> | (NFTAttributeValue | { i32: any } | { u8: any } | { u16: any } | { u32: any } | { u64: any } | { u128: any } | { Bytes32: any } | { Bytes: any } | { Text: any } | { Hash: any } | { Timestamp: any } | { Url: any } | string | Uint8Array)[], metadataPath: Option<Bytes> | null | object | string | Uint8Array, royaltiesSchedule: Option<RoyaltiesSchedule> | null | object | string | Uint8Array, massDrop: Option<MassDrop> | null | object | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [CollectionId, TokenCount, Option<AccountId>, Vec<NFTAttributeValue>, Option<Bytes>, Option<RoyaltiesSchedule>, Option<MassDrop>]>;
      /**
       ...
       **/
      setMassDropActivationTime: AugmentedSubmittable<(collectionId: CollectionId | AnyNumber | Uint8Array, seriesId: SeriesId | AnyNumber | Uint8Array, newActivationTime: BlockNumber | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [CollectionId, SeriesId, BlockNumber]>;
      /**
       * Add presale conditions to existing mass_drop or change presale values
       **/
      setMassDropPresale: AugmentedSubmittable<(collectionId: CollectionId | AnyNumber | Uint8Array, seriesId: SeriesId | AnyNumber | Uint8Array, presale: Presale | { price?: any; transactionLimit?: any; activationTime?: any; maxSupply?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [CollectionId, SeriesId, Presale]>;
      /**
       ...
       **/
      setPresaleActivationTime: AugmentedSubmittable<(collectionId: CollectionId | AnyNumber | Uint8Array, seriesId: SeriesId | AnyNumber | Uint8Array, newActivationTime: BlockNumber | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [CollectionId, SeriesId, BlockNumber]>;
      /**
       ...
       **/
      setPresaleWhitelist: AugmentedSubmittable<(collectionId: CollectionId | AnyNumber | Uint8Array, seriesId: SeriesId | AnyNumber | Uint8Array, accountIds: Vec<AccountId> | (AccountId | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [CollectionId, SeriesId, Vec<AccountId>]>;
      /**
       ...
       **/
      updateMetadataUris: AugmentedSubmittable<(collectionId: CollectionId | AnyNumber | Uint8Array, seriesId: SeriesId | AnyNumber | Uint8Array, metadataUris: Vec<Bytes> | (Bytes | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [CollectionId, SeriesId, Vec<Bytes>]>;
    };
    rewards: {
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
      /**
