...
import type { Bytes, Compact, Data, Option, U8aFixed, Vec, bool, i64, u16, u32, u64 } from '@polkadot/types';
...
import type { AccountId, AccountIndex, Address, AssetId, Balance, BalanceOf, BlockNumber, Call, ChangesTrieConfiguration, H256, Hash, Header, KeyValue, LookupSource, Moment, OpaqueCall, Perbill, Weight } from '@polkadot/types/interfaces/runtime';
...
declare module '@polkadot/api/types/submittable' {
  export interface AugmentedSubmittables<ApiType> {
    ...
    rewards: {
       ...
       **/
      setInflationRate: AugmentedSubmittable<(numerator: i64 | AnyNumber | Uint8Array, denominator: i64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    scheduler: {
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
      /**
