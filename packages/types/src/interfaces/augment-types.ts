...
import type { AuctionClosureReason, AuctionListing, CollectionId, FixedPriceListing, InnerId, Listing, ListingId, MetadataURI, NFTAttributeName, NFTAttributeTypeId, NFTAttributeValue, NFTSchema, Reason, RoyaltiesSchedule, TokenCount, TokenId } from '@cennznet/types/interfaces/nft';
...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    InnerId: InnerId;
    'Compact<InnerId>': Compact<InnerId>;
    'Option<InnerId>': Option<InnerId>;
    'Vec<InnerId>': Vec<InnerId>;
    Listing: Listing;
