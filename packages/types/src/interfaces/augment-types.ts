...
import type { BlockLength, BlockWeights, ConsumedWeight, Direction, DispatchClassTo36, DispatchInfoTo36, Food, PerDispatchClass, PerDispatchClassU32, PhaseTo36, Slot, Snake, WeightPerClass, WeightTo36, WindowSize, doughnut } from '@cennznet/types/interfaces/system';
...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    'Vec<Food>': Vec<Food>;
    Snake: Snake;
    'Option<Snake>': Option<Snake>;
    'Vec<Snake>': Vec<Snake>;
    WindowSize: WindowSize;
    'Option<WindowSize>': Option<WindowSize>;
    'Vec<WindowSize>': Vec<WindowSize>;
