...
import { AnyNumber, AnyU8a, ExtrinsicPayloadValue, IKeyringPair, Registry } from '@polkadot/types/types';
...
export default class CENNZnetExtrinsic extends GenericExtrinsic{
  ...
  setNonce(value: AnyNumber){
    this.signaturePayloadOptions.nonce = value;
    return this;
  }
  ...
  setPaymentOpts(api: Api, { feeAssetId, slippage = 0, tip = 0 }: PaymentOptions): this{
    const _maxPayment = Infinity.toString();
